...
namespace SkillBridges.Data
{
    public class SkillBridgeContext:DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Payment>().HasOne(p => p.Task).WithMany().HasForeignKey(p => p.TaskId).OnDelete(DeleteBehavior.Restrict);
            modelBuilder.Entity<Payment>().HasOne(p => p.ClientProfile).WithMany().HasForeignKey(p => p.ClientProfileId).OnDelete(DeleteBehavior.Restrict);
